...
<!-- 
	파일 업로드 구현(실 저장 경로)
	http://localhost:8090/WebJSP/Ex09_WebApp_RealPath.jsp -> 웹경로
	
	Ex09_WebApp_RealPath.jsp의 실제 서버의 물리적인 경로는 어디일까?
	실제소스와 배포되어서 서비스되고 있는 소스는 다르다. (동기화 되어 있어서 하나처럼 움직일 뿐 다른경로에 있다.)
	
	실경로(소스) -> C:\Users\LEEBOHEE\bit2021\Web(Back)\WebLabs\WebJSP\WebContent\Ex09_WebApp_RealPath.jsp
	실경로(배포) -> C:\Users\LEEBOHEE\bit2021\Web(Back)\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
	             *아파치 톰켓의 서비스 경로*
	
	* 업로드된 파일 -> resourcepath = "/download/note.txt" 
	소스경로 : C:\Users\LEEBOHEE\bit2021\Web(Back)\WebLabs\WebJSP\WebContent\download\note.txt    
	배포경로 : C:\Users\LEEBOHEE\bit2021\Web(Back)\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt     
 -->
...
<%
	...
	out.print("contextPath를 통한 real path 보기 :<br>" + realContextPath + "<br>");
